              ...
              <div className="flex items-center space-x-4 ml-4">
                {isLoading ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={() => logout()}
                      className="bg-gray-900 text-white hover:bg-brand-red px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm cursor-pointer"
                    >
                      Logout
                    </button>
                  </>
          ...
          <div className="md:hidden absolute top-16 left-0 w-full bg-white shadow-lg border-b border-gray-100 animate-fade-in-up">
            <div className="px-4 pt-2 pb-6 space-y-4 flex flex-col">
              ...
              <div className="border-t border-gray-100 my-2 pt-2 space-y-2">
                {isLoading ? (
                  <span className="block text-center text-sm text-gray-400 py-2">...</span>
                ) : isLoggedIn && user ? (
                  <>
                    ...
                    <button
                      ...
                      className="block w-full text-center px-4 py-2 border border-transparent rounded-md text-base font-medium text-white bg-brand-red hover:bg-red-800 shadow-sm cursor-pointer"
                    >
                      Logout
                    </button>
                  </>
